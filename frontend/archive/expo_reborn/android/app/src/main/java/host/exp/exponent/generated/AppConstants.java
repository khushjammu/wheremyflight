...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@khushjammu/where-my-flight";
  public static final String SHELL_APP_SCHEME = "exped744a4809584b3eac3bc4aa97ac031f";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@khushjammu/where-my-flight", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40khushjammu%2Fwhere-my-flight%2F1.0.0%2Fd394add34e61077b83d454d93987f4af-32.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
