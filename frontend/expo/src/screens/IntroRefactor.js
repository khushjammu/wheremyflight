          ...
          if (res['status'] === 'success') {
            if (res['data']['direction'] === 'arrival') {
              ...
              Alert.alert(
                ...
                [
                  {text: 'Arrivals', onPress: () => this.props.navigation.navigate("InfoPageRefactor", {flight_num: this.state.text, origin: res['data']["arrival"]["from"],destination: "Singapore",terminal: "T" + res['data']["arrival"]["terminal"],date: new Intl.DateTimeFormat().format(new Date(this.state.date)),arrival_time: res['data']["arrival"]["estimatedTime"] != "" ? res['data']["arrival"]["estimatedTime"] : res['data']["arrival"]["scheduledTime"],belt_no: res['data']["arrival"]["belt"],status: res['data']["arrival"]["status"] != "" ? res['data']["arrival"]["status"] : "Scheduled"})},
                  {text: 'Departures', onPress: () => this.props.navigation.navigate("InfoPageRefactor", {flight_num: this.state.text, origin: "Singapore", destination: res['data']["departure"]["to"],terminal: "T" + res['data']["departure"]["terminal"],date: new Intl.DateTimeFormat().format(new Date(this.state.date)),arrival_time: res['data']["departure"]["estimatedTime"] != "" ? res['data']["departure"]["estimatedTime"] : res['data']["departure"]["scheduledTime"],belt_no: res['data']["departure"]["belt"],status: res['data']["departure"]["status"] != "" ? res['data']["departure"]["status"] : "Scheduled"})}
                ],
                { cancelable: true }
              );
            }
