...
export default class InfoPageSuccess extends Component {
  constructor(props) {
    ...
    // var url =
    //   "http://10.180.8.71:5000/get_flights?date=" +
    //   js_lib.format(
    //     this.props.navigation.getParam("date", "NO-ID"),
    //     "YYYYMMDD"
    //   ) +
    //   "&flight_code=" +
    //   this.props.navigation.getParam("flight_num", "NO-ID");
      ...
      <View style={styles.root}>
        ...
        <Center horizontal>
          <View style={styles.infoHolder}>
            ...
            <Center horizontal>
              <Text style={styles.singapore}>{this.state.destination}</Text>
            </Center>
            <View style={styles.info}>
              <View style={styles.belt}>
                <Center vertical>
                  <Text style={styles.style}>{this.state.belt_no}</Text>
                </Center>
              ...
              <View style={styles.date}>
                <Text style={styles.style1}>{this.state.date}</Text>
              ...
              <View style={styles.arrivalTime}>
                <Text style={styles.pm}>{this.state.arrival_time}</Text>
                <Image
              ...
              <View style={styles.terminal1}>
                <Text style={styles.t1}>{this.state.terminal}</Text>
            ...
            <Center horizontal>
              // <Text style={styles.onTime}>{this.state.status}</Text>
              <Text
                style={[
                  this.state.status == "Landed" ||
                  this.state.status == "Confirmed"
                    ? styles.onTime
                    : styles.schedulededTime
                ]}
              >
                {this.state.status}
              </Text>
            ...
            <Center horizontal>
              <Text style={styles.shanghai}>{this.state.origin}</Text>
            </Center>
          </View>
        </Center>
        <Center horizontal>
          <View style={styles.flightHolder}>
            ...
            <Center>
              <Text style={styles.k459}>{this.state.flight_num}</Text>
            </Center>
          </View>
        </Center>
        <Svg
